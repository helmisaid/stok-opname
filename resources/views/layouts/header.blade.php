...
<li class="nav-item dropdown-hover d-none d-lg-block me-2">
<a class="nav-link" href="{{ asset('dark/app-calendar.html') }}') }}">Calendar</a>
</li>
<li class="nav-item dropdown-hover d-none d-lg-block">
<a class="nav-link" href="{{ asset('dark/app-email.html') }}') }}">Email</a>
</li>
</ul>
<!-- ------------------------------- -->
...
<a href="{{ asset('dark/page-user-profile.html') }}" class="dropdown-item px-7 d-flex align-items-center py-6">
...
<a href="{{ asset('dark/app-email.html') }}" class="dropdown-item px-7 d-flex align-items-center py-6">
...
<a href="{{ asset('dark/app-notes.html') }}" class="dropdown-item px-7 d-flex align-items-center py-6">
